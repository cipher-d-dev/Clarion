  ...
  return (
    <div className="space-y-6">
      <PageHeader
        title="My Complaints"
        action={
          <Link href="/dashboard/lecturer/complaints/new">
            <Button variant="accent" size="sm" className="gap-2"><Plus className="h-4 w-4" /> New</Button>
          </Link>
        }
      />
      ...
      {isLoading ? (
        ...
        <EmptyState title="No complaints found"
          action={<Link href="/dashboard/lecturer/complaints/new"><Button variant="accent" size="sm">Submit one</Button></Link>} />
      ) : (
        <>
