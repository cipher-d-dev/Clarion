...
export default function NewComplaintPage() {
  ...
  const onSubmit = async (data: CreateComplaintInput) => {
    ...
    try {
      ...
      router.push(`/dashboard/student/complaints/${result.data.id}`);
    } catch (err) {
        ...
        <CardContent>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
            ...
            <FormField>
              ...
              <FormControl>
                <Input placeholder="Brief summary of your complaint" {...form.register("title")} />
              </FormControl>
            ...
            <FormField>
              ...
              <FormControl>
                <textarea
                  className="w-full rounded-md border border-input bg-background px-3 py-2 text-sm ring-offset-background placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring min-h-[120px] resize-y"
